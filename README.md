...
| Launch | Notebook |
|---|---|
| [![](https://img.shields.io/badge/launch-marimo-6925d3?logo=marimo&logoColor=white)](https://sdsc-binder.flatironinstitute.org/~acasey/sdss?urlpath=marimo/edit/notebooks/marimo/inspect_aspcap_fits.py) | **Inspect ASPCAP fits**: Interactively inspect ASPCAP fits to APOGEE spectra, by _Emily Griffith_ |
| [![](https://img.shields.io/badge/launch-marimo-6925d3?logo=marimo&logoColor=white)](https://sdsc-binder.flatironinstitute.org/~acasey/sdss?urlpath=marimo/edit/notebooks/marimo/mwm_minisurvey_0.9.4_explorer.py) | **MWM Mini-Survey 0.9.4 Explorer**: Interactive explorer for `mwmStar-0.9.4` APOGEE spectra — look up sources and view spectra, by _Kayvon Sharifi_ |
