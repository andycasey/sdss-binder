...
var samp = (function() {
    ...
    // PATCHED for ES module use: these were implicit globals, which throw
    // ReferenceError under the strict mode that ES modules always run in.
    ...
    Connection.prototype.close = function() {
        ...
        if (this.onclose) {
            // PATCHED for ES module use: `oc` was an implicit global, which
            // throws under strict mode and broke Connection.close().
            var oc = this.onclose;
            delete this.onclose;
            try {
                oc();
